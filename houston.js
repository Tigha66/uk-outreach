...
const businesses = [
  { name: "Abacus Plumbing", email: 'info@abacusplumbing.net', city: 'Houston', type: 'Plumber', website: 'abacusplumbing.net' },
  { name: "1-Tom-Plumber Houston", email: 'houston@1tomplumber.com', city: 'Houston', type: 'Plumber', website: '1tomplumber.com' },
  { name: "Texas Quality Plumbing", email: 'info@texasqualityplumbing.com', city: 'Houston', type: 'Plumber', website: 'texasqualityplumbing.com' },
  { name: "All The Time Plumbing", email: 'info@allthetimeplumbing.com', city: 'Houston', type: 'Plumber', website: 'allthetimeplumbing.com' },
  { name: "Plomero Yanez", email: 'info@plomeroyanez.com', city: 'Houston', type: 'Plumber', website: 'plomeroyanez.com' },
  { name: "All In The Family Plumbing", email: 'service@allinthefamilyplumbing.com', city: 'Houston', type: 'Plumber', website: 'allinthefamilyplumbing.com' },
];
